...
export async function addCardMembers(cardId, emails) {
    ...
    if (toAdd.length === 0) {
        throw new Error(skipped.length === uniqueEmails.length
...
export async function removeCardMembers(cardId, emails) {
