...
export const ATTACHMENT_CACHE_DIR =
  process.env.ANTURIO_ATTACHMENT_CACHE_DIR ??
...
export function mimeToExt(mimeType: string, fallbackName?: string): string {
...
export function toMarkdownFilePath(filepath: string, label: string): string {
...
export function toMarkdownImagePath(filepath: string, alt: string): string {
