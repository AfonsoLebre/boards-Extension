...
- `archive_card` - Arquiva um cartão (requer confirm: true)
- `unarchive_card` - Desarquiva um cartão
...
| "Arquiva o cartão X" | `archive_card` com confirm: true |
| "Desarquiva o cartão X" | `unarchive_card` |
